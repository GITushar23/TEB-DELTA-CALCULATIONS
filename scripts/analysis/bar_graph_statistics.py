...
OUT_DIR = ROOT / "bar_graph_statistics"
...
def main() -> None:
    ...
    binary_summary.to_csv(TABLES_DIR / "binary_grouped_statistics.csv", index=False)
    ternary_summary.to_csv(TABLES_DIR / "ternary_grouped_statistics.csv", index=False)
