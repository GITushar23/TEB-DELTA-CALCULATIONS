...
Examples:
    python plot_ternary_pair_focus_interactive.py Ag-Fe
    python plot_ternary_pair_focus_interactive.py --all
    python plot_ternary_pair_focus_interactive.py --all --workers 8
"""
...
INPUT_CSV = ROOT / "packing_efficiency_results" / "ternary" / "tables" / "packing_vs_delta_merged.csv"
OUT_DIR = ROOT / "packing_efficiency_results" / "ternary" / "interactive_plots"
